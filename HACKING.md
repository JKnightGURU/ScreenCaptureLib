...
hidden if the `ScreenCaptureLib_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ScreenCaptureLib_DEVELOPER_MODE` to the configure
